...
export const Third = withNavigationContext(({ fullpage }) => (
  <Section wrapper={false} backgroundColor="#ff6f5e">
    ...
    <Content
      main={<Lettering title="PAGE-THREE" text={['This is a screen with preloaded background image.']} />}
      action={
        <div className="button">
          <AwesomeButton
            size="large"
    ...
    children: (
      <Page>
        <Section wrapper={false} backgroundColor="#4158b4">
          <Content
            main={
              <Lettering title="PAGE-TWO" text={['This is multiple section page, scroll down to view more content.']} />
            }
            action={<Mouse />}
          />
        </Section>
        <Section backgroundColor="#617be3">
          <Lettering title="PAGE-SECTION" text={['This is a continued page section.']} />
        </Section>
      </Page>
    ),
  },
